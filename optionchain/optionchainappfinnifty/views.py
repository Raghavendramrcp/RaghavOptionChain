...
def option_chain_view(request, pk):
    ...
    bank_nifty_symbol = 'NSE:NIFTYFINSRV2550-INDEX'
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            next_week_expiry_str = '2023-07-04'
            ...
            for data in option_chain_data:
                ...
                if expiry_date == next_week_expiry_date:
                    if "CE" in data:
                        ...
                        if strike_price % 50 == 0 and strike_price >= quote_value - 250 and strike_price <= quote_value + 250:
            ...
            return render(request, 'optionchainappfinnifty/optionchainappfinnifty.html', context)

        else:
            context = {
                "error": f"Request failed with status code: {response.status_code}"
            }
            return render(request, 'optionchainappfinnifty/optionchainappfinnifty.html', context, status=response.status_code)

    except requests.RequestException as e:
        context = {
            "error": "An error occurred"
        }
        return render(request, 'optionchainappfinnifty/optionchainappfinnifty.html', context, status=500)
